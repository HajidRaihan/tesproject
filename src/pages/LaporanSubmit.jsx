...
const LaporanSubmit = () => {
  ...
  return (
    <div>
      <NavigationBar />
      <div className="flex justify-center items-center w-screen md:mb-0 mb-36 h-fit">
        <div className="md:w-2/3 overflow-y-auto w-screen mx-3 border border-gray-500 rounded-2xl md:p-12 p-5 mt-28 ">
          <div className="flex justify-between">
            <h1 className="md:text-4xl text-xl font-semibold">Masalah</h1>
            <button
              className="md:px-5 px-3 md:py-3 py-2 text-md bg-button-laporan  text-white rounded-lg font-medium"
